...
var sekolah = [
    L.marker([-8.676964464580124, 116.38291128831663], { icon: iconSekolah }).addTo(sekolahCluster).bindPopup(` <img src="asset/leaflet/images/sd1.png">`),
...
const map = L.map('map', {
    ...
    zoom: 13,
    layers: [layer2, sekolahCluster, masjidCluster, tokoCluster, puskesmasCluster]
